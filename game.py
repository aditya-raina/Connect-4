...
def winning_move(board, piece):
	...
	for c in range(COLUMN_COUNT):
		for r in range(ROW_COUNT-5):
			if board[r][c] == piece and board[r+1][c] == piece and board[r+2][c] == piece and board[r+3][c] == piece and board[r+4][c] == piece and board[r+5][c] == piece:
				return True
	...
	for c in range(COLUMN_COUNT-5):
		for r in range(5, ROW_COUNT):
			if board[r][c] == piece and board[r-1][c+1] == piece and board[r-2][c+2] == piece and board[r-3][c+3] == piece and board[r-4][c+4] == piece and board[r-4][c+4] == piece:
				return True
